...
$(document).ready(function () {
  ...
  $(".antifraud__slider").on("beforeChange", function (
    event,
    slick,
    currentSlide,
    nextSlide
    ...
    setCss3Style(
      document.getElementsByClassName("circl_lock")[0],
      "transition-duration",
      transliteTimeText
    );
    setCss3Style(
      document.getElementsByClassName("svg_lock_path")[0],
      "transition-duration",
      transliteTimeText
    );
    ...
    if (currentSlide < nextSlide) {
      ...
      var myVar = setInterval(function () {
        if (i <= nextSlide) {
          $(".circl_lock").css({
            transform: "translate(" + coordArray[i] + ")",
          });
          $(".svg_lock_path").css("stroke-dasharray", pathArray[i]);
        } else {
          clearInterval(myVar);
  ...
  $(document).on("click", ".mobile_header__burger", function () {
    if (!$(".mobile_header__content").hasClass("active")) {
      ...
      setTimeout(() => {
        ...
        $(".menu__heading__mobile").siblings(".menu").slideUp();
  ...
  $(document).on("click", ".mobile_header", function (e) {
    if (
      $(this).hasClass("active") &&
      e.target.classList.contains("mobile_header")
    ) {
      if (!$(".mobile_header__content").hasClass("active")) {
        $(".mobile_header").addClass("active");
      } else {
  ...
  $(document).on("click", ".footer-menu-row--heading", function () {
    if ($(window).width() < 900) {
      if (!$(this).hasClass("active")) {
        $(this).addClass("active");
        $(".footer-menu-row--heading").siblings(".menu").slideUp();
  ...
  function mobileMediaSlider() {
    $(".events_sidebar__ul").slick({
      arrows: false,
      dots: false,
      variableWidth: true,
      slidesToScroll: 3,
  ...
  $(document).on("click", ".mobile_header__big_list > li > span", function () {
    if (!$(this).hasClass("active")) {
      ...
      $(this).siblings(".mobile_header__middle_list").slideDown();
    } else {
      $(this).removeClass("active");
      $(this).parent("li").removeClass("active");
      $(this).siblings(".mobile_header__middle_list").slideUp();
    }

    $(this)
      .siblings(".mobile_header__big_list > li > .mobile_header__small_list")
      .slideToggle();
  });
  ...
  $(document).on(
    ...
    function () {
      if (!$(this).hasClass("active")) {
        ...
        $(this).addClass("active");
        $(this).parent("li").addClass("active");
        $(this).siblings(".mobile_header__small_list").slideDown();
      } else {
        $(this).removeClass("active");
        $(this).parent("li").removeClass("active");
        $(this).siblings(".mobile_header__small_list").slideUp();
      }
    }
  );
  ...
  $(document).on("click", ".mobile_header_about--js_btn", function (e) {
    e.preventDefault();
    $(".mobile_header__content_menues").hide();
    $(".mobile_header__language_content").hide();
    $(".mobile_header__about").show();
    $(".mobile_header").animate(
      {
        scrollTop: $(".mobile_header__content").offset().top,
      },
      700
    );
  });

  $(document).on("click", ".mobile_header__language", function () {
    if (!$(".mobile_header__content").hasClass("active")) {
      $(".mobile_header").addClass("active");
      $(".mobile_header__burger").addClass("active");
      $(".mobile_header__content").addClass("active");
      $(".mobile_header__content_menues").hide();
      $(".mobile_header__about").hide();
      $(".mobile_header__language_content").show();
    } else {
      $(".mobile_header__content_menues").hide();
      $(".mobile_header__about").hide();
      $(".mobile_header__language_content").show();
  ...
  function setActivePage() {
    let activePage = $(".events_sidebar__li.active");

    $(".events_sidebar__li.active")
      .remove()
      .promise()
      .done(function () {
        $(".slick-track").prepend(activePage);
      });
  }
